...
__Note that this article includes a complete solution. If you are looking for some hints for Villager A, the keywords are `Format String Vulnerability` and `GOT overwrite`.__
